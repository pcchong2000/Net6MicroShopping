...
using Shopping.Identity.AccountApplication;
...
namespace Shopping.Api.IdentityTenant
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            builder.Services.AddMySqlDbContext<TenantDbContext>(builder.Configuration["ConnectionString"]);
            builder.Services.AddDataSeed<DataSeed>();
            ...
            //初始化数据库和数据
            await app.Services.RunDataMigrate<TenantDbContext>();
            await app.Services.RunDataSeed();
